...
import 'common_blocs/auth/auth_bloc.dart' as _i36;
...
import 'common_blocs/player/player_bloc.dart' as _i29;
...
import 'services/api/user_service.dart' as _i16;
import 'services/local_storage/local_storage.dart' as _i7;
import 'services/local_storage/local_storage_impl.dart' as _i8;
import 'ui/screens/album_detail/bloc/album_detail_bloc.dart' as _i34;
import 'ui/screens/artist_detail/bloc/artist_detail_bloc.dart' as _i35;
...
import 'ui/screens/playlist_detail/bloc/playlist_detail_bloc.dart' as _i30;
import 'ui/screens/profile/bloc/profile_bloc.dart' as _i31;
import 'ui/screens/rank/bloc/rank_bloc.dart' as _i32;
import 'ui/screens/search/bloc/search_bloc.dart' as _i33;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i15.UserRecentPlaylistsBloc>(_i15.UserRecentPlaylistsBloc(
      gh<_i10.PlaylistService>(),
      gh<_i7.LocalStorage>(),
    ));
    gh.factory<_i16.UserService>(() => _i16.UserService(gh<_i3.DioClient>()));
    ...
    gh.factory<_i24.GetArtistsBloc>(
        () => _i24.GetArtistsBloc(gh<_i16.UserService>()));
    ...
    gh.factory<_i27.GetUsersBloc>(
        () => _i27.GetUsersBloc(gh<_i16.UserService>()));
    gh.factory<_i28.HomeSectionsBloc>(
        () => _i28.HomeSectionsBloc(gh<_i6.HomeService>()));
    gh.singleton<_i29.PlayerBloc>(_i29.PlayerBloc(gh<_i13.SongService>()));
    gh.factory<_i30.PlaylistDetailBloc>(
        () => _i30.PlaylistDetailBloc(gh<_i10.PlaylistService>()));
    gh.factory<_i31.ProfileBloc>(() => _i31.ProfileBloc(
          gh<_i16.UserService>(),
          gh<_i9.MeService>(),
        ));
    gh.lazySingleton<_i32.RankBloc>(
        () => _i32.RankBloc(gh<_i13.SongService>()));
    gh.factory<_i33.SearchBloc>(
        () => _i33.SearchBloc(gh<_i12.SearchService>()));
    gh.factory<_i34.AlbumDetailBloc>(
        () => _i34.AlbumDetailBloc(gh<_i17.AlbumService>()));
    gh.factory<_i35.ArtistDetailBloc>(
        () => _i35.ArtistDetailBloc(gh<_i18.ArtistService>()));
