...
import 'common_blocs/albums/albums_bloc.dart' as _i18;
...
import 'services/api/account_service.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i10.PlaylistsBloc>(() => _i10.PlaylistsBloc(
          gh<_i9.PlaylistService>(),
          gh<_i7.LocalStorage>(),
        ));
    ...
    gh.factory<_i16.AccountService>(
        () => _i16.AccountService(gh<_i3.DioClient>()));
    gh.factory<_i17.AlbumService>(() => _i17.AlbumService(gh<_i3.DioClient>()));
    gh.factory<_i18.AlbumsBloc>(() => _i18.AlbumsBloc(gh<_i17.AlbumService>()));
    ...
    gh.factory<_i23.PlaylistDetailBloc>(
        () => _i23.PlaylistDetailBloc(gh<_i9.PlaylistService>()));
    gh.factory<_i24.ProfileBloc>(
        () => _i24.ProfileBloc(gh<_i15.UserService>()));
    ...
    gh.factory<_i27.AlbumDetailBloc>(
        () => _i27.AlbumDetailBloc(gh<_i17.AlbumService>()));
    gh.factory<_i28.ArtistDetailBloc>(
        () => _i28.ArtistDetailBloc(gh<_i19.ArtistService>()));
    gh.lazySingleton<_i29.AuthBloc>(() => _i29.AuthBloc(
          gh<_i20.AuthService>(),
          gh<_i16.AccountService>(),
          gh<_i7.LocalStorage>(),
        ));
    return this;
  }
