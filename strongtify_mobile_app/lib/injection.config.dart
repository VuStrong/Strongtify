...
import 'services/api/artist_service.dart' as _i17;
import 'services/api/auth_service.dart' as _i18;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i17.ArtistService>(
        () => _i17.ArtistService(gh<_i3.DioClient>()));
    gh.factory<_i18.AuthService>(() => _i18.AuthService(
          gh<_i3.DioClient>(),
          gh<_i7.LocalStorage>(),
        ));
